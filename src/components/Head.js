        ...
        <Row className="align-items-center desktopHeader">
          ...
          <Col md={7}>
            <ul className="appMenuList">
              ...
              <li>
                <NavLink to="/celebrity-voices" exact>Celebrity Voices</NavLink>
              </li>
              <li>
                <NavLink to="/voice-search" exact>Voice Search</NavLink>
              </li>
              <li>
              ...
              <li>
                <NavLink to="/blogs" exact>Blog </NavLink>
              </li>
        ...
        <Row className="mobileHeader">
          ...
          <div className="menuLink">
            <ul>
              ...
              <li><NavLink to="/" onClick={closeMenu} exact>About</NavLink></li>
              <li><NavLink to="/" onClick={closeMenu} exact>Contact</NavLink></li>
            </ul>
          </div>
        </Row>
      </header>
